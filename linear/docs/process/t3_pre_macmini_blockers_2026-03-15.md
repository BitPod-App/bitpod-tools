...
| Final canonical branch strategy | `FAIL` | useful work is preserved and pushed, but most active repos are still on `codex/...` preserve branches | decide what "final enough" means before T3 can pass honestly |
...
2. Decide and record what "final enough" means for the current preserve branches.
