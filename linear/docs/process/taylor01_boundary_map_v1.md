...
| Historical `/Users/cjarguello/bitpod-app/local-workspace/local-codex/skills/qa-specialist/**` | Taylor01 Portable Core | `portable` | `retired-reference` | Transitional QA skill surface retained only as migration context; post-BIT-614 Vera identity canon lives in `taylor01-mind/agents/vera/SOUL.md` and active gate mechanics live under `bitpod-tools/linear/` |
