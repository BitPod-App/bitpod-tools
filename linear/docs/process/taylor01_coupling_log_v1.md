...
| T01-C13 | `/Users/cjarguello/.agents/skills/qa-specialist/**` | Home-directory skill coupling | The old QA mirror has been reduced to a compatibility symlink outside the canonical workspace root | Keep `local-codex` as canonical local surface and retire the shim once runtime compatibility is clear |
| T01-C15 | `/Users/cjarguello/.agents/skills/taylor/**` | Home-directory skill coupling | The old Taylor mirror has been reduced to a compatibility symlink outside the canonical workspace root | Keep `local-codex` as canonical local surface and retire the shim once runtime compatibility is clear |
