...
- `$WORKSPACE/bitpod-tools/linear/contracts/runtime_states_v1.json`
- `$WORKSPACE/bitpod-tools/linear/contracts/agent_registry_v1.json`
- `$WORKSPACE/bitpod-tools/linear/contracts/tool_registry_v1.json`
- `$WORKSPACE/bitpod-tools/linear/examples/taylor_delegated_trace_v1.json`
