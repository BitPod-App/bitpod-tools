...
Recommended repo-side location for active operational checkpoints in `bitpod-tools`:

- `linear/docs/process/checkpoints/`

Recommended file set:

- `active_checkpoint_<lane>_<yyyy-mm-dd>.md`
