...
- historical QA implementation surface at checkpoint time:
  - canonical local surface then: `/Users/cjarguello/bitpod-app/local-workspace/local-codex/skills/qa-specialist/SKILL.md`
  - post-BIT-614 note: this skill path is not live canon; Vera identity canon lives in `taylor01-mind/agents/vera/SOUL.md`
