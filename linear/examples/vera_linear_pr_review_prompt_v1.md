...
- If QA cannot safely reach pass/fail (legacy `NO_VERDICT`), emit `QA_RESULT=SKIPPED` with `qa-skipped`, end the report with `QA_VERDICT: SKIPPED`, and explain what is missing
