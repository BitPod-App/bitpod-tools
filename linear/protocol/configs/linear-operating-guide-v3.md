...
Supersedes: `linear-operating-guide-v2.md` as the active guide
...
- Store durable protocol artifacts under `/bitpod-tools/linear/protocol/` and retained change artifacts under `/bitpod-tools/linear/temporal/`.
...
- Workflow, schema, template, automation, or other meaningful admin changes must follow `linear-admin-change-control-v1.md`.
...
- Taylor01 portability review gate from `taylor01-portability-review-gate-v1.md`
- active issue evidence contract from `linear_issue_template_evidence_contract_v2.md`
- Linear admin/process change-control from `linear-admin-change-control-v1.md`
- proposal workflow from `linear_change_proposal_template_v1.md`

Artifacts:

- `linear-operating-guide-v3.md`
- `linear_issue_template_evidence_contract_v2.md`
- `taylor01-portability-review-gate-v1.md`
- `linear-admin-change-control-v1.md`
...
1. Set the active guide version back to `v2` in `linear-operating-guide-changelog.md`.
