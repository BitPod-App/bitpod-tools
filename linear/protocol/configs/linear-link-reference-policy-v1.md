...
This policy should also be mirrored in:

- global Codex instructions
- relevant `AGENTS.md` files
- any local skill used for comment, PR, or doc drafting

If mirrored elsewhere, this file remains the canonical source of truth.

## Related workspace reference

For the current local umbrella-workspace model and repo/container rules, see:

- `/Users/cjarguello/BitPod-App/bitpod-docs/process/codex-org-workspace-model.md`
