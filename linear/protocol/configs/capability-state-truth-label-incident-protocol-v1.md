...
Status: Active companion protocol
...
- [`truthfulness-and-verification-policy.md`](/Users/cjarguello/BitPod-App/bitpod-docs/process/truthfulness-and-verification-policy.md)

This file is the narrower operational companion for incident handling, session
re-anchoring, and capability-state execution. The canonical definitions for
truthfulness, verification, certainty control, and anti-drift policy live in
the BitPod docs policy above.
...
## Operational Truth Labels (required on capability-critical claims)
