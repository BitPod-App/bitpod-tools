<!-- BEGIN GENERATED GLOBAL POLICY BLOCK -->
Read these first for global policy:
...
<!-- END GENERATED GLOBAL POLICY BLOCK -->

# bitpod-tools AGENTS

Add repo-specific instructions below the generated global policy block.
